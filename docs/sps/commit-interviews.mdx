...
:::note
Our candidates join Commit with the expectation that their first call with a startup partner is with the hiring manager. This allows candidates to dive deeper into the role, go over the tech stack, discuss specific projects they may be a part of, and learn more about the team they'd be joining.
:::
