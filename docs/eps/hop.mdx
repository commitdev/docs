---
title: Hackathon Onboarding Projects
sidebar_label: Hop
sidebar_position: 2
---
...
[Google Drive](https://drive.google.com/drive/u/1/folders/1xPY1nQUeTTlN_lfIDQwrYVde4zQx8_vf)
...
**Main Contact**: Phong  
**Slack**: #wolfie-bot  
[**Github Repo**](https://github.com/commitdev/commit-bot)
...
- Random coffee between two EPs (similar to Donut)
- Kudos tracker (Phong)
...
**Main Contact**: Phong  
**Slack**: #project-helix  
[**Backend Github Repo**]: (https://github.com/commitdev/helix-service)
[**Frontend Github Repo**]: (https://github.com/commitdev/helix-ui)
...
- Go to [App](https://app.commit.dev)
...
- Covid19
  - There is a whole slack group dedicated to building products to help with the Covid19 situation.
...
You will be working with [Ryan Abbottto](mailto:ryan.abbott@commit.dev) write a blog post about your HOP Demo. This is an opportunity to Work-out-loud and share your learning experience with the community.

Check out past posts here!

- https://blog.commit.dev/articles/polishing-the-platform-my-hackathon-onboarding-project
- https://blog.commit.dev/articles/chop-the-commit-hackathon-onboarding-project
...
Please refer to the DESIGN.md documentation for implementation and DX concepts.
...
[**Github**](https://github.com/commitdev/zero)
